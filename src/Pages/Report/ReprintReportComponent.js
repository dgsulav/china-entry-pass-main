...
import {
  getAllReprintCardReport,
  getReprintCardReport,
} from "../../Redux/Report/thunk";

import { dateFormater } from "../../utils/dateFormater";
import { statusTypesReprint } from "../../Component/Data/Data";
import Select from "react-select";
import { loadOptionsOffice } from "./asyncFunction";

const ReprintReportComponent = ({
  name,
  ...
  const onSubmit = async (values) => {
    ...
    if (quickReport) {
      if (paginatedData) {
        if (name === "report") {
          dispatch(getReprintCardReport(postsPerPage, body));
        ...
        if (name === "report") {
          dispatch(getAllReprintCardReport(body));
          setShowReportModal(true);
          setShowExcelReportModal(false);
          setShowPDFReportModal(false);
        }
...
export default React.memo(ReprintReportComponent);
