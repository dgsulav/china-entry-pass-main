...
function setFont(
  ...
  myFont.sWeight = isBold
    ? wgssSignatureSDK.FontWeight.FW_BOLD
...
function addObjectImage(imageObj, callbackRoutine, imageSource) {
  ...
  wizCtl.AddObject(
    wgssSignatureSDK.ObjectType.ObjectImage,
    imageObj.buttonType,
    xVar,
    yVar,
    objData,
...
function addCheckBox(xPosition, yPosition, optionsValue, callbackRoutine) {
  ...
  wizCtl.AddObject(
    wgssSignatureSDK.ObjectType.ObjectCheckbox,
    "Check",
    xVar,
    yVar,
    objData,
...
function addRectangle(rectangleObj, callbackRoutine) {
  ...
  wizCtl.AddPrimitive(
    wgssSignatureSDK.PrimitiveType.PrimitiveRectangle,
    x1Var,
    y1Var,
    x2Var,
    y2Var,
...
function addLine(lineObj, callbackRoutine) {
  ...
  wizCtl.AddPrimitive(
    wgssSignatureSDK.PrimitiveType.PrimitiveLine,
    x1Var,
    y1Var,
    x2Var,
    y2Var,
...
function addRadioButton(radioButtonObj, callbackRoutine) {
  ...
  wizCtl.AddObject(
    wgssSignatureSDK.ObjectType.ObjectRadioButton,
    radioButtonObj.buttonLabel,
    xVar,
    yVar,
    objData,
    options,
...
function addInputObject(inputObj, callbackRoutine) {
  ...
  wizCtl.AddObject(
    wgssSignatureSDK.ObjectType.ObjectInput,
    "input",
    xVar,
    yVar,
    objData,
...
function addInputObjectEcho(xPos, yPos, callbackRoutine) {
  ...
  wizCtl.AddObject(
    wgssSignatureSDK.ObjectType.ObjectInputEcho,
    "echo",
    xVar,
    yVar,
    objData,
...
function getCurrentDir() {
  ...
  var scriptPath = scriptFullName.substring(
    1,
    scriptFullName.lastIndexOf("\\") + 1
  ); // c:\pathname\
